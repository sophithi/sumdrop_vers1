...
@endif
        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="field-row">
                <div class="field">
                    ...
                    <select id="unit" name="unit" onchange="document.getElementById('pack_quantity_field').style.display = this.value === 'case' ? 'block' : 'none'; document.getElementById('piece_pricing_field').style.display = this.value === 'case' ? 'block' : 'none';">
                        ...
                        <option value="case" @selected(old('unit') === 'case')>{{ __('products.case_pack') }}</option>
                    </select>
                    @error('unit')<div class="field-error">{{ $message }}</div>@enderror
                </div>
                <div class="field" id="pack_quantity_field" style="display: {{ old('unit') === 'case' ? 'block' : 'none' }};">
            ...
            <div class="field-row" id="piece_pricing_field" style="display: {{ old('unit') === 'case' ? 'block' : 'none' }};">
                <div class="field">
